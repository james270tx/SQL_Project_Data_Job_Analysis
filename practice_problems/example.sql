...
Find the count of the number of remote job postings per skill
    ...
    - Include skill id, name, and number of job postings requiring this skill
...
UNION combines the results from 2 or more SELECT statements
--They need to have the same amount of columns and the data type must match
--Gets rid of duplicate rows, unline UNION ALL. All rows are unique
...
Find job postings from the 1st quarter that have a salary greater than 70000
--Combine job postings tables from the first quarter of 2023
--Get job postings with an average yearly salary greater than 70000
